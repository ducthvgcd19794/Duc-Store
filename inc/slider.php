			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						...
						<div class="button"><span><a href="details.php?proid=<?php echo $result_ap['productId'] ?>">Add to Cart</a></span></div>
				   </div>
			   </div>
			   <?php
				}}
				...
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						...
						<div class="button"><span><a href="details.php?proid=<?php echo $result_hw['productId'] ?>">Add to Cart</a></span></div>
				   </div>
			   </div>
			   <?php
				}}
